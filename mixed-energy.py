...
h1, exact1, ref1 = np.loadtxt('mixed-energy0.dat', usecols=(0, 1, 2), unpack=True)
h2, ref2, ea2, eb2, barb2, ec2, barc2, ed2, bard2 = np.loadtxt('mixed-energy.dat', usecols=(0, 2, 3, 4, 5, 6, 7, 8, 9), unpack=True)
...
rect = patches.Rectangle((0.0,-0.025),2.0,0.045,linewidth=0.75,edgecolor='k',facecolor='none',ls='--')
ax1.add_patch(rect)
ax1.legend()
...
ax1.set_xlabel(r'$T$')
ax1.set_ylabel('residual free energy per site')
plt.savefig('mixed-energy.pdf', bbox_inches='tight', pad_inches=0.01)
